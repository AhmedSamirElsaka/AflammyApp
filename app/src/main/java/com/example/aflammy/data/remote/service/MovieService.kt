package com.example.aflammy.data.remote.service

import com.example.aflammy.data.remote.response.*
import com.example.aflammy.data.remote.response.account.*
import com.example.aflammy.data.remote.response.actor.*
import com.example.aflammy.data.remote.response.episode.*
import com.example.aflammy.data.remote.response.genre.*
import com.example.aflammy.data.remote.response.login.*
